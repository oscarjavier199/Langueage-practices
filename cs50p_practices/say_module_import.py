...
import sys
from sayings_module_import import hello #imported from sayings.py (another local file)
from sayings_module_import import goodbye #imported from sayings.py (another local file)
