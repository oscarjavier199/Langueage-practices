# Practice of accessing dicts key, value pairs.
...
spread['past'] = tarot.pop(9, "The Hermit")
spread['present'] = tarot.pop(19, "The Sun")
spread['future'] = tarot.pop(10, "Wheel of Fortune")

for fortune, card in spread.items():
    print(f"Your {fortune} is the {card} card!")