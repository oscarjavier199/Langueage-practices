# Remove all the 'Ace' cards from the dict

deck_of_cards = {'Ace of Spades': 1, '2 of Spades': 2, '3 of Spades': 3,  '4 of Spades': 4,
                 ...
                 'Jack of Diamonds': 10, 'Queen of Diamonds': 10, 'King of Diamonds': 10, 'Ace of Hearts': 1,
                 ...
                 'Queen of Hearts': 10, 'King of Hearts': 10, 'Ace of Clubs': 1, '2 of Clubs': 2, '3 of Clubs': 3,
...
# Cards to remove
cards_to_remove = ('Ace of Spades', 'Ace of Diamonds', 'Ace of Hearts', 'Ace of Clubs')

#iterate over the cards to remove and remove them using pop from the dict
for key_card in cards_to_remove:
  deck_of_cards.pop(key_card, None)
