...
#we can write the program using len() to get the lenght of the list and then print it
"""""
students =["Hermione", "Harry", "Ron"]
for i in range(len(students)): #using len() to get the lenght of the list
...
#loop to iterate to all the items in the dictionarie
for student in students:
